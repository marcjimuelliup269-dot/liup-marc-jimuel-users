...
<head>
    ...
    <title>Create account | Product Desk</title>
    <style>
...
<body><main>
    ...
    <form method="post" action="/register">
        ...
        <label for="password_confirmation">Confirm password</label><input id="password_confirmation" name="password_confirmation" type="password" required minlength="8" autocomplete="new-password">
